...
def make_horiz_bins(data, fft_bin_size, overlap, box_height):
    ...
    # print "this is data"
    # print data
    # print "this is sample_data"
    # print sample_data
    # print "end"
    # with open("/home/zzy/Documents/datadetails.txt","w+") as f:
    #     f.write(str(data))
    ...
    for j in range(int(fft_bin_size - overlap), len(data), int(fft_bin_size-overlap)):
        ...
        x_coord_counter += 1
    print "this is horiz_bins type"
    print type(horiz_bins)
    # with open("/home/zzy/Documents/horiz_bins.txt","w+") as f:
    #     f.write(str(horiz_bins))
...
def fourier(sample):  #, overlap):
    ...
    # print "this is fft_data"
    # print fft_data
    # print fft_data[1]
    # print fft_data[1].real
    # print fft_data[1].imag
    # print "this is fft_data end"
...
def find_bin_max(boxes, maxes_per_box):
    ...
    for key in boxes.keys():
        # print "this is find max bin key:"
        # print key
...
def find_freq_pairs(freqs_dict_orig, freqs_dict_sample):
    ...
    for key in freqs_dict_sample.keys():  # iterate through freqs in sample
        ...
        # print type(key)
        # print key
        # with open("/home/zzy/Documents/keydata.txt","wb+")as f:
        #     f.write(str(key)+'\n')
    ...
    # print "this is time pairs"
    # print time_pairs
    # with open("/home/zzy/Documents/timepairs.txt","wb+")as f:
    #     f.write(str(time_pairs)+'\n')
    return time_pairs
...
def align(video1, video2, dir, fft_bin_size=1024, overlap=0, box_height=512, box_width=43, samples_per_box=7):
    ...
    # wavfile1 = "/home/zzy/Videos/other/ladinggirlWAV10.wav"
    ...
    # wavfile2 = "/home/zzy/Videos/other/ladinggirlWAV20.wav"
    raw_audio2, rate = read_audio(wavfile2)
    print "this is the length of raw_audio2"
    print len(raw_audio2)
